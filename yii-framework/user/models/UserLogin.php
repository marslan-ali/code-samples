...
class UserLogin extends CFormModel
{
    ...
    public function rules()
    {
        return array(
            ...
            array('username, password', 'required','on'=>'default'),
            // rememberMe needs to be a boolean
            array('rememberMe', 'boolean','on'=>'default'),
            // password needs to be authenticated
            array('password', 'authenticate','on'=>'default'),
            array('facebookId,username', 'required', 'on' => 'fblogin'),
            array('facebook', 'authenticateFacebook', 'on' => 'fblogin')
        );
    }
    ...
    public function authenticateFacebook($attribute, $params)
    {
        $identity = new FacebookIdentity($this->username, $this->facebookId);
